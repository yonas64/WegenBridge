  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)]">
          ...
          <div className="w-full max-w-xl">
            <div className="text-center mb-8">
              <div className="inline-flex items-center mb-4">
                ...
                <h1 className="text-3xl font-bold text-gray-900">Join Our Mission</h1>
              </div>
              <p className="text-gray-600">Create an account to help reunite families</p>
            </div>

            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900">Create Account</h2>
                <p className="text-gray-600 mt-2">Join thousands of volunteers helping families reconnect</p>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {[
                      ...
                      { value: "family", label: "Family Member", icon: "❤️" },
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-12 pr-12 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all ${
                ...
                <div className="space-y-4">
                  <label className="flex items-start cursor-pointer">
                    ...
                    <span className="ml-3 text-sm text-gray-700">
                      ...
                      . I understand that all information shared is handled with utmost confidentiality.
                    </span>
                  </label>
                  ...
                  <label className="flex items-start cursor-pointer">
                    ...
                    />
                    <span className="ml-3 text-sm text-gray-700">
                      I'd like to receive updates about missing persons, success stories, and how I can help.
                    </span>
                  </label>
                </div>
            ...
            <div className="mt-8 text-center text-sm text-gray-500">
              <div className="flex items-center justify-center">
                ...
                <p>All information is confidential and protected</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-purple-600 to-blue-700 text-white p-8 lg:p-12 hidden lg:flex flex-col justify-center">
          <div className="max-w-lg mx-auto">
            <div className="mb-10">
              <h1 className="text-4xl font-bold mb-4">
                Join Our Community of <span className="text-yellow-300">Hope</span>
              </h1>
              <p className="text-blue-100 text-lg">
                Together, we've helped reunite over 1,200 families. Your registration brings us one step closer to the next reunion.
              </p>
            </div>

            <div className="space-y-8">
              <div className="flex items-start">
                <div className="bg-white/20 p-3 rounded-xl mr-4 mt-1">
                  <Users className="h-6 w-6" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Join 5,000+ Volunteers</h3>
                  <p className="text-blue-100">Be part of a growing community dedicated to helping families reconnect.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Help as much or as little as you can. Every contribution matters.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Receive alerts about missing persons in your area and help when you can.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 flex items-center justify-center text-white font-bold text-lg mr-4">
                  MJ
                </div>
                <div>
                  <h4 className="font-bold text-lg">Michael Johnson</h4>
                  <p className="text-blue-100">Volunteer for 2 years</p>
                </div>
              </div>
              <p className="italic text-blue-100">
                "Registering as a volunteer was the best decision I've made. Last month, I helped reunite a mother with her daughter. This work changes lives."
              </p>
            </div>
